...
public class MemberController {
    ...
    public ResponseEntity<String> checkNickname(@RequestBody @Valid MemberRequest.CheckNickname request) {
        memberService.validateNicknameNotExists(MemberCommand.ValidateNicknameNotExists.create(request.getNickname()));
        return ResponseEntity.ok("OK");
    }

    @PostMapping("/signup/verify-email")
    public ResponseEntity<MemberResponse.RequestEmailVerification> requestEmailVerification(
        ...
        return ResponseEntity.ok(
            MemberResponse.RequestEmailVerification.create(requestEmailVerification.getVerificationCode())
        );
    }

    @PostMapping("/signup/verify-email/confirm")
    public ResponseEntity<String> confirmEmailVerification(@RequestBody @Valid MemberRequest.ConfirmEmailVerification request) {
    ...
    @PostMapping("/signup")
    public ResponseEntity<String> signup(@RequestBody @Valid MemberRequest.Signup request) {
        memberFacade.signup(
